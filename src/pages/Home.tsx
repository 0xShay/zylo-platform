        ...
        <>
            ...
            <div className="flex flex-col xl:flex-row p-8 xl:p-16">
                ...
                <div className="p-8 xl:w-1/3 flex flex-col justify-center items-center">
                    <h1 className="text-4xl xl:ml-16 xl:mr-16 text-center text-zylo-blue-300">Our mission is to promote a <b>sustainable</b> lifestyle and reduce environmental impact.</h1>
                ...
                <div className="p-8 xl:w-1/3 flex flex-col justify-center items-center border-t border-b xl:border-t-0 xl:border-b-0 xl:border-l xl:border-r border-black">
                    <h1 className="text-4xl xl:ml-16 xl:mr-16 text-center text-zylo-blue-200">Zylo provides <b>high-quality</b>, sustainably sourced clothing for eco-conscious consumers.</h1>
                    <p className="text-xl mt-4 xl:ml-16 xl:mr-16 text-center">
                ...
                <div className="p-8 xl:w-1/3 flex flex-col justify-center items-center">
                    <h1 className="text-4xl xl:ml-16 xl:mr-16 text-center text-zylo-blue-400">We support <b>ethical</b> production and fair trade practices.</h1>
                    <p className="text-xl mt-4 xl:ml-16 xl:mr-16 text-center">
